...
import me.suman.shopapi.security.JWT.JwtProvider;
import me.suman.shopapi.service.UserService;
import me.suman.shopapi.vo.request.LoginForm;
import me.suman.shopapi.vo.response.JwtResponse;
...
public class UserController {
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody LoginForm loginForm) 
    {
        ...
        try {
            ...
            System.out.println(" Before jwt call");
            String jwt = jwtProvider.generate(authentication);
            System.out.println(" after jwt call");

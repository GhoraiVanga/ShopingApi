package me.suman.shopapi.security;
...
import me.suman.shopapi.security.JWT.JwtEntryPoint;
import me.suman.shopapi.security.JWT.JwtFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception{
    	System.out.println("1st Configur for jdbc");
    	auth
                .jdbcAuthentication()
    ...
    {
    	System.out.println("1st Configur for AuthenticationManager");
    ...
    {
    	System.out.println("1st Antmatcher");
        ...
        System.out.println("2st Antmatcher");
    }
